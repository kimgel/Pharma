...
//Update updateApprovalStatus
exports.update = function(req, res) {
    //initiateevent.approver = req.user;
    var updateApprovalStatus = req.initiateevent;
    //updateApprovalStatus.approver = req.user;
    updateApprovalStatus = _.extend(updateApprovalStatus, req.body);

    updateApprovalStatus.save(function(err) {
        if (err) {
            return res.send('login', {
                errors: err.errors,
            ...
            res.jsonp(updateApprovalStatus);
        }
    });
};
...
exports.create = function(req, res) {
    ...
    newInitiateEvent.approver = null;
    newInitiateEvent.modified_by = null;
