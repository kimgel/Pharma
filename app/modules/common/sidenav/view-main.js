...
define(['app'], function(app) {
    app.controller('MainNavCtrl', [
        ...
        function($scope) {
            $scope.initiateeventDd = [
                {
                    "text": "Propose",
                    "ui_sref": 'propose_event'
                },
                {
                    "text": "Approve",
                    "ui_sref": 'approve_event'
                }
            ],
            ...
            $scope.closeeventDd = [
                {
                    ...
                    "ui_sref": 'close_event_receive'
                },
                {
                    "text": "Reimbursements",
                    "ui_sref": 'close_event_reimbursements'
                }
            ],
            $scope.inventoryDd = [
                {
                    "text": "Equipment",
                    "ui_sref": 'equipment_master'
                },
                {
                    "text": "Supplies",
                    "ui_sref": 'supplies_master'
                }
            ];
    ...
    app.directive('uiBreadcrumbs', function($interpolate, $state) {
        return {
            restrict: 'AE',
            templateUrl: '/modules/common/header/uiBreadcrumbs.tpl.html',
            scope: {
                displaynameProperty: '@',
